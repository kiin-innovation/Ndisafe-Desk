...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Slogan_tip", "Made From a thousand hills Native"),
        ...
        ("install_tip", "Due to UAC, NDISafe Desk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install NDISafe Desk to the system."),
        ...
        ("powered_by_me", "Powered by Ndisafe"),
