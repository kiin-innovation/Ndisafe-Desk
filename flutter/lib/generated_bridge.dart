...
class NdisafeDeskImpl implements NdisafeDesk {
  final NdisafeDeskPlatform _platform;
  factory NdisafeDeskImpl(ExternalLibrary dylib) =>
      NdisafeDeskImpl.raw(NdisafeDeskPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory NdisafeDeskImpl.wasm(FutureOr<WasmModule> module) =>
      NdisafeDeskImpl(module as ExternalLibrary);
  NdisafeDeskImpl.raw(this._platform);
  Stream<String> startGlobalEventStream(
      {required String appType, dynamic hint}) {
...
class NdisafeDeskPlatform extends FlutterRustBridgeBase<NdisafeDeskWire> {
  NdisafeDeskPlatform(ffi.DynamicLibrary dylib) : super(NdisafeDeskWire(dylib));
...
class NdisafeDeskWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  NdisafeDeskWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  NdisafeDeskWire.fromLookup(
